...
<html>
   ...
   <body>
    ...
    <div class="gradient">
    	...
    	{
    		while($row=mysqli_fetch_array($result))//in row array of result
    		{
    			if($count==0)
	  			{
	  			?>
    	...
    	?>
    		 <div class="col s12 l3">   
    		    <form method="post" action="shopping_cart.php?action=add&id=<?php echo $row["id"];?>">
    	          <div class="card small">
    	          	<div class="card-image waves-effect waves-block waves-light">
	    				<img class="activator responsive-img" src="images/softtoys/<?php echo $row["img"];?>"/><br/>
	    			</div>
              ...
              <input type="hidden" name="hidden_category" value="softtoys"> <!--for displaying in shopping_cart image-->
