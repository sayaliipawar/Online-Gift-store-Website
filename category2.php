            ...
            <div class="nav-wrapper">
               ...
               <ul id="nav-mobile" class="right hide-on-med-and-down">
                <form action="search.php" method="POST">
                  <li><input type="text" name="search" placeholder="search" class="navlink"></li>
                  <?php
    ...
    <div class="gradient">
    	...
    	?>
    		 <div class="col s12 l3">   
    		    <form method="post" action="shopping_cart.php?action=add&id=<?php echo $row["id"];?>">
    	          <div class="card small">
    	          	<div class="card-image waves-effect waves-block waves-light">
	    				<img class="activator responsive-img" src="images/phonecase/<?php echo $row["img"];?>"/><br/>
	    			</div>
              ...
              <input type="hidden" name="hidden_category" value="phonecase">
